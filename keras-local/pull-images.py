...
def get_product_preview_image(keyword):
    print keyword
    ...
    return list(map(lambda x: (x['id'], x['images'][0]['large']), json_data['data']['searchProducts']['results']))
...
if __name__ == '__main__':
    ...
    for keyword in imagenetClasses:
        search_results = get_product_preview_image(keyword)

        for result_tuple in search_results:
            (product_id, image_url)= result_tuple
            try:
                urllib.urlretrieve(image_url, './images/analyze_' + keyword.replace(" ", "_") + '_' + product_id + '.jpg')
            except:
                print "malformed url"
